...
export default function PrivacyPolicy() {
  return (
    <main className="bg-greyPurple text-lightBlack">
      <SiteHeader />
      <div className="privacyPolicy container py-14">
        <h1 className="text-6xl font-bold font-roobert text-center pb-14">
          Privacy Policy
        </h1>
        <h2>
        ...
        <ul>
          <li>
            Visit our website at minescale.net, or any website of ours that
        ...
        <p>
          ...
          email us at info@minescale.net.
        </p>
        <h2>
        ...
        <p>
          ...
          us at info@minescale.net. We will inform you in writing of any action
